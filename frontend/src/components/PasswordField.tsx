    ...
    <div className="mb-5">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-1 top-1/2 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-lg text-inkdim transition-colors hover:text-inkmid"
        >
          {visible ? (
